...
class World_model extends CI_Model {
    ...
    function json() {
        ...
        $this->datatables->add_column('view','<a class="btn btn-xs btn-warning btn " href="edit/$1">edit</a>| <a class="btn btn-xs btn-danger" href="hapus_fpps/$1">delete</a>| <a class="btn btn-xs btn-success" href="delete/$1">lihat</a>| <a class="btn btn-xs btn-success" href="delete/$1">print</a>', 'record_number_customer');
