                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-user"></i>User <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="<?php echo base_url(); ?>C_admin/daftar_user">User</a></li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul class="nav child_menu">
                      ...
                      <li><a href="index3.html">LAB BAKTERI</a></li>
                      <li><a href="index2.html">LAB VIRUS</a></li>
                      <li><a href="index3.html">LAB LAB KIMIA</a></li>
                    </ul>
                  </li>
